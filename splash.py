...
def mesg():  # draw the message
    ...
    ui.center(x, mesg_y+dev.font_height*1, 'HACK', fg, bg)
    ui.center(x, mesg_y+dev.font_height*2, 'A', fg, bg)
    ui.center(x-24, mesg_y+dev.font_height*2, '\x10', fg, bg)
    ui.center(x+24, mesg_y+dev.font_height*2, '\x11', fg, bg)
    ui.center(x, mesg_y+dev.font_height*3, 'THON', fg, bg)
    ui.center(x, mesg_y+dev.font_height*4, '2023', fg, bg)
    ui.center(x, mesg_y+dev.font_height*5, 'TEAM22', fg, bg)
    ui.center(x, mesg_y+dev.font_height*6, 'LRImA', fg, bg)
